...
class PlotterParams(BaseSettings):
    ...
    def __init__(self) -> None:
        ...
        # Model 5 in mm !
        self.x_travel_SEA1_mm = (
            864  # AxiDraw SE/A1: X             Default: 34.02 in (864 mm)
        )
        self.y_travel_SEA1_mm = (
            594  # AxiDraw SE/A1: Y             Default: 23.39 in (594 mm)
        )

        # Model 6
        self.x_travel_SEA2_mm = (
            594  # AxiDraw SE/A2: X             Default: 23.39 in (594 mm)
        )
        self.y_travel_SEA2_mm = (
            432  # AxiDraw SE/A2: Y             Default: 17.01 in (432 mm)
        )

        # Model 2
        self.x_travel_V3A3_mm = (
            430  # V3/A3 and SE/A3: X           Default: 16.93 in (430 mm)
        )
        self.y_travel_V3A3_mm = (
            297  # V3/A3 and SE/A3: Y           Default: 11.69 in (297 mm)
        )
...
class OverloadedSettings(BaseSettings):
    ...
    def __init__(self) -> None:
        ...
        self.speed_pendown = (
            25  # Maximum plotting speed, when pen is down (1-100). Default 25
        )
        self.speed_penup = (
            75  # Maximum transit speed, when pen is up (1-100). Default 75
        )
        ...
        self.const_speed = (
            False  # Use constant velocity mode when pen is down. Default False
        )
